 ...
 */
public class ExecuteScript implements ExecutableWithInput, ExecutableCommandMaker {
    ...
    public Executable[] getCommands() {
        ...
        for (String currentLine : lines) {
            ...
            String mode = "SCRIPT";
            commandsFromScript.add(CommandKeeper.getPreparedCommand(commandName, commandArg, mode));
        }

...
import Lab6.CommandsM.ExecuteScript;
import Lab6.CommandsM.General.*;
...
public class ClientSide {
     ...
     * @param address Stirng-адрес сервера
    ...
    public void loop(String address, int port){
        ...
        try(Socket socket = new Socket(address, port);
            ...
            while(socket.isConnected()){
                ...
                final String COMMANDS_EXECUTION_MODE = "STANDARD";
                Executable command = CommandKeeper.getPreparedCommand(commandName, arg, COMMANDS_EXECUTION_MODE);
                if(command == null){
